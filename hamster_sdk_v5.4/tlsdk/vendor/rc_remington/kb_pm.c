...
_attribute_ram_code_ void kb_pm_proc(void)
{
...
#else
	kb_sleep.device_busy = kb_status.rf_sending ;
	...
	kb_sleep.next_wakeup_tick = kb_sleep.wakeup_tick + 21400*16;
    ...
    while ( !clock_time_exceed (kb_sleep.wakeup_tick, 400) );
