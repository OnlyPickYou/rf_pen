...
#define KB_MANUAL_PARING_MOST	   (2750/KB_MAIN_LOOP_TIME_MS)  //手动配对最大时间
#define KB_NO_QUICK_SLEEP_CNT	   (10000/KB_MAIN_LOOP_TIME_MS)  //LINK最大时间
#define KB_PARING_POWER_ON_CNT      30    						 //上电自动配对包
...
extern void kb_rf_proc(u32 key_scaned, u8 bat_low_det);
