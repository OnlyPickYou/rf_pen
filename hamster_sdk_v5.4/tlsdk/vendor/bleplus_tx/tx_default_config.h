...
#define KB_RM_GHOST_KEY_EN   			0   //no need remove ghost key, if keyboard application, please enable
...
#define  KEYBOARD_DRIVE_PINS  {GPIO_PB1, GPIO_PB2, GPIO_PB3, GPIO_PB6}
#define  KEYBOARD_SCAN_PINS   {GPIO_PD4, GPIO_PD5, GPIO_PD6, GPIO_PD7, GPIO_PE0, GPIO_PE1}
