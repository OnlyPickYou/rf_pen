...
#define	ID_PRODUCT				(0x8366 + USB_PRINTER + USB_KEYBOARD_ENABLE * 2)
...
#define  DEBUG_DONGLE_CAVY_MOUSE			0

#if(DEBUG_DONGLE_CAVY_MOUSE)

#undef  USB_PRINTER
#define USB_PRINTER					1

#define TEST_SINGLE_FRE				0
#define PRINT_RCVD_PACKET			0
