...
addr :  0x3f05
default  0xff:  manual             1111 1111
         0xcf:  soft        	   1100 1111
         0xaf:  auto			   1010 1111
         0x6f:  golden dongle	   0110 1111
         0xdf:  manual + soft	   1101 1111
 *******************************************************/
...
#define		CUSTOM_DONGLE_MANNUAL_PARING	BIT(4)     // 1 for  munaul  paring

#define		CUSTOM_DONGLE_AUTO_PARING_M2	BIT(3)     // 1 for  munaul  paring
...
typedef struct{
	...
	u16  prodct_id;        // 0d-0e
	u8   tx_power_emi;     // 0f
	u8   memory_type;      // 10  0xff for flash,0 for otp
	...
	u8	 hw_ver;		   // 13  0xb0~0xbf
	u8	 sw_ver;		   // 14  0xc0~0xcf
} custom_cfg_t;
